...
ALARM_PATH := vendor/lineagepixel/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/lineagepixel/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/lineagepixel/prebuilt/common/media/audio/ringtones
